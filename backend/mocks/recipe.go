...
func (m *MockIRecipeRepository) GetAll(ctx context.Context, filter *dto.RecipeFilter, page int) ([]*domain.Recipe, error) {
	m.ctrl.T.Helper()
...
// GetAll mocks base method.
func (m *MockIRecipeService) GetAll(ctx context.Context, filter *dto.RecipeFilter, page int) ([]*domain.Recipe, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAll", ctx, filter, page)
	ret0, _ := ret[0].([]*domain.Recipe)
	ret1, _ := ret[1].(error)
