...
func (m *MockISaladRepository) GetAll(ctx context.Context, filter *dto.RecipeFilter, page int) ([]*domain.Salad, int, error) {
	m.ctrl.T.Helper()
...
// GetAll mocks base method.
func (m *MockISaladService) GetAll(ctx context.Context, filter *dto.RecipeFilter, page int) ([]*domain.Salad, int, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAll", ctx, filter, page)
	ret0, _ := ret[0].([]*domain.Salad)
	ret1, _ := ret[1].(int)
